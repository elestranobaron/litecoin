...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " muscleupcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  muscleupcoin-tx [options] <hex-tx> [commands]  Update hex-encoded muscleupcoin transaction\n" +
            "or:     muscleupcoin-tx [options] -create [commands]   Create hex-encoded muscleupcoin transaction\n" +
            "\n";
