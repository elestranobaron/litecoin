...
public:
    CMainParams() {
        ...
        /*vSeeds.emplace_back("seed-a.muscleupcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.muscleupcointools.com");
        vSeeds.emplace_back("dnsseed.muscleupcoinpool.org");*/
...
public:
    CTestNetParams() {
        ...
        /*vSeeds.emplace_back("testnet-seed.muscleupcointools.com");
        vSeeds.emplace_back("seed-b.muscleupcoin.loshan.co.uk");
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 0 0
            /* nTime    */ 1486949366,
            /* nTxCount */ 0,
            /* dTxRate  */ 0.0
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.nPowTargetTimespan = 0.5 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 2.5 * 60;
        consensus.fPowAllowMinDifficultyBlocks = true;
