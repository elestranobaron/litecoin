...
"""Verify that starting muscleupcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start muscleupcoin with -h for help text")
        ...
        self.log.info("Start muscleupcoin with -version for version information")
        ...
        self.log.info("Start muscleupcoind with -fakearg to make sure it does not start")
