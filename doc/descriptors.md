# Support for Output Descriptors in Muscleupcoin Core

Since Muscleupcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Muscleupcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Muscleupcoin Core wallets, a convenience function `combo` is
